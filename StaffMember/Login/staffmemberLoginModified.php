...
if (isset($_SESSION['username'])) {
    header("Location:../Home/homeModified.php");
}
...
if (isset($_POST["submit"])) {
    ...
    $sql = "SELECT staff_no, password_hash, first_name FROM staffmember WHERE email = '$username'";
    ...
    if ($result) {
        ...
        if (password_verify($password, $hash)) {
            ...
            header("Location:staffmemberLoginModified.php?state=invalid_credentials");
        }
    } else {
...
<body>
    ...
    <div class="main_container">
        ...
        <div class="form">
            ...
            <form action="staffmemberLoginModified.php" method="post">
